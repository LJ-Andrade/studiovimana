<div id="contact" class="container-fluid contact-section">
	<div class="container wow animated fadeIn">
		<div class="row inner">
			...
			{{-- <h1>CONTACTANOS !</h1> --}}
			{{--  <img src="{{secure_asset('webimages/logos/main-logo.png')}}" class="wow animated zoomIn" data-wow-delay="1.5s" data-wow-duration="3s">  --}}
		...
		<div class="horizontal-list social-icons">
			...
			<ul>
				<a href="https://www.facebook.com/studiograficovimana" target="_blank">
					<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s"><img src="{{ secure_asset('webimages/gral/social/social1.png') }}"></li>
				</a>
				<a href="https://twitter.com/StudioVimana" target="_blank">
					<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s"><img src="{{ secure_asset('webimages/gral/social/social2.png') }}"></li>
				</a>
				<a href="https://www.youtube.com/channel/UCFT-sFx3Pv-r3ozgEqqnWfA" target="_blank">
					<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s"><img src="{{ secure_asset('webimages/gral/social/social3.png') }}"></li>
				</a>
				<a href="https://es.pinterest.com/admstudiovimana/" target="_blank">
					<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s"><img src="{{ secure_asset('webimages/gral/social/social4.png') }}"></li>
				</a>
				<a href="https://www.behance.net/studiovimana" target="_blank">
					<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s"><img src="{{ secure_asset('webimages/gral/social/social5.png') }}"></li>
				</a>
				<a href="https://plus.google.com/u/0/+StudioVimana" target="_blank">
					<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.7s"><img src="{{ secure_asset('webimages/gral/social/social6.png') }}"></li>
				</a>
				<a href="https://github.com/StudioVimana" target="_blank">
					<li class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s"><img src="{{ secure_asset('webimages/gral/social/social7.png') }}"></li>
				</a>
			</ul>
		</div>
	</div>
