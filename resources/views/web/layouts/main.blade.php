...
<html lang="es">
	<head>
		...
		<meta property="og:image" content="{{ asset('webimages/logos/main-logo.png') }}" alt="Studio Vimana Logo"/>
		<meta property="og:site_name" content="http://vimana.studio">
		<meta property="og:locale" content="es_ES">
		<meta property="fb:app_id" content="1305647396212353">


		<meta name="twitter:title" content="Studio Vimana" />
		<meta name="twitter:image" content="{{ asset('webimages/logos/main-logo.png') }}" alt="Studio Vimana Logo"/>
