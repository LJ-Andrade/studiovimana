     ...
     <div class="row inner">
        ...
        <div class=" col-md-12 form-group">
            ...
            <div class="col-md-6">
                ...
                {!! Form::select('type', ['user' => 'Usuario','admin' => 'Admin', 'superadmin' => 'SuperAdmin'], null, ['class' => 'form-control', 'placeholder' => 'Seleccione una opcion']) !!}
            </div>
            <div class="col-md-6">
                {!! Form::label('role', 'Rol') !!}
				{!! Form::select('role', ['author' => 'Autor', 'none' => 'Ninguno'], null, 
				['class' => 'form-control', 'placeholder' => 'Seleccione una opción...'])!!}
            </div>
        </div>
            {{-- Error --}}
        <div class="col-md-12 error-container">
            <div class="FormNewError error-content"></div>
        </div>
