				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="{{ route('portfolio.index') }}"><i class="ion-ios-briefcase"></i> Portfolio | Listado</a></li>
						</ul>
					</li>
					<li class="dropdown">
						...
						<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="{{ route('categories.index') }}"><i class="ion-folder"></i> Categorías</a></li>
							<li><a href="{{ route('tags.index') }}"><i class="ion-pricetag"></i> Tags</a></li>
						</ul>
					</li>
					<li class="dropdown">
